...
import { AccessoryType, IAccessoryFilter } from '@common/endpoints/useMasterAccessories'
...
const AccessoriesConfigurationsContainer: FC<{
  ...
  const compatibleModelsFunctions = (value: AccessoryType['compatibleModels'], filter: string) => {
  ...
  return (
    <>
      <div className="pt-0 pb-3 px-4 bg-white rounded" data-testid="accessories-table">
        <Table
          ref={tableRef}
        ...
        >
          ...
          <Column
            ...
            filterFunction={compatibleModelsFunctions}
            filterElement={
              <Select
